...
export function CTA() {
  return (
    <section id="contact" className="relative py-5 md:py-6 lg:py-8 px-6">
      ...
      >
        <img src={cta} alt="Incredible India" className="absolute inset-0 w-full h-full object-cover" loading="lazy" />
        ...
        <div className="relative px-8 md:px-14 py-10 md:py-12 max-w-3xl">
          ...
          <p className="mt-5 text-luxury-gray max-w-lg">
            Bas share your dates, dream destination and travel style. We'll send a friendly, tailored quote within 24 hours — no pushy calls, promise.
          </p>
          <div className="mt-8 flex flex-col sm:flex-row gap-4">
            <a href="#" className="btn-gold px-8 py-4 rounded-full text-sm uppercase tracking-[0.2em] font-medium">Get Free Quote</a>
            <a href="#" className="btn-ghost-luxe px-8 py-4 rounded-full text-sm uppercase tracking-[0.2em] font-medium">Chat on WhatsApp</a>
          </div>
        </div>
      </motion.div>
    </section>
