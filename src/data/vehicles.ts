...
export const CATEGORIES: Category[] = [
  {
    id: "hatchback",
    name: "Hatchbacks",
    blurb: "Nimble city runabouts and budget-friendly day rentals.",
  },
  {
    id: "sedan",
    name: "Sedans",
    blurb: "Executive comfort for business travel, weddings and city transfers.",
  },
  {
    id: "suv",
    name: "SUVs",
    blurb: "Confident long-distance vehicles for hills, highways and family trips.",
  },
  {
    id: "muv",
    name: "MPVs / Family Cars",
    blurb: "Spacious people movers with room for luggage and the whole family.",
  },
  {
    id: "luxury",
    name: "Luxury Cars",
    blurb: "VIP-grade chauffeur experiences for weddings, executives and milestone events.",
  },
  {
    id: "tempo",
    name: "Tempo Travellers",
    blurb: "Pushback-seat group transport for pilgrimages and team outings.",
  },
  {
    id: "urbania",
    name: "Force Urbania",
    blurb: "Premium captain-seat coaches for high-end group travel.",
  },
  {
    id: "bus",
    name: "Buses",
    blurb: "Mini, deluxe and luxury coaches for large groups, weddings and corporate events.",
  },
];
...
export const VEHICLES: Vehicle[] = [
  ...
  // Tempo Travellers
  {
    ...
    local: [5500, 7000],
    outstation: [23, 25],
    notes: ["Toll Tax Extra", "Driver Allowance Extra"],
  },
  {
  ...
  // Buses
  {
    ...
    local: [8000, 12000],
    outstation: [35, 45],
    notes: ["AC / Non-AC", "Pushback Seats"],
  },
  {
    slug: "deluxe-bus-55",
    name: "Deluxe Bus (55 Seater)",
    category: "bus",
    seats: 55,
    image: deluxeBus,
    local: [15000, 25000],
  ...
  },
  {
    ...
    name: "Luxury Coach Bus (45 Seater)",
    category: "bus",
    seats: 45,
    image: luxuryCoach,
    local: [20000, 35000],
    outstation: [55, 75],
    notes: ["AC", "Premium Interior", "Pushback Seats"],
  },
];
