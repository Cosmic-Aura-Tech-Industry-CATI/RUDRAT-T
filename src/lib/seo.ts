    ...
    "@graph": [
      {
        ...
        description:
          "Rudra Tours & Travels is a premier travel agency, cab booking service and car rental provider based in Kanpur, Uttar Pradesh. Operating since 2014, offering 24x7 local taxi hire, outstation cabs to Lucknow, Ayodhya, Varanasi & Delhi, luxury wedding cars (Audi, BMW, Mercedes), 12-26 seater tempo travellers, and custom pilgrimage and holiday packages across India.",
        slogan: "Kanpur's Trusted Tour Operator & Cab Service Since 2014",
        knowsAbout: [
          "Tours and Travels in Kanpur",
          "Best Cab Service in Kanpur",
          "Car Rental Kanpur",
          "Taxi Service Kanpur",
          "Tempo Traveller in Kanpur",
          "Wedding Car Rental Kanpur",
          "Outstation Cabs from Kanpur",
        ...
        sameAs: [
          BRAND.mapsUrl,
          ...(BRAND.socialLinks.length ? BRAND.socialLinks.map((link) => link.href) : []),
        ],
        address,
        contactPoint: [
          {
