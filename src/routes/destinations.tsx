  ...
  return (
    <PageLayout>
      ...
      <PageHero
        ...
        title={
          <>
            India tour destinations you'll <span className="shine-text italic">love</span> to visit.
          </>
        }
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-2 mb-6">
                  {p.highlights.map((h) => (
                    <span
                      key={h}
                      className="px-4 py-1.5 rounded-full glass text-xs text-luxury-gray"
                    >
                      {h}
                    </span>
                  ))}
